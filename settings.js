...
global.owner = process.env.OWNER_NUMBER  || '923167437883' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=6NUWgb7D#oXQPr4prVZHRE_uEWwBX1M4mbw8-k1cKbi-M2NHKlok' ,
